...
scp -i ../../.aws/admin-key-pair-euwest1.pem ./.env ec2-user@ec2-52-212-119-153.eu-west-1.compute.amazonaws.com:~/.env

# Copy the docker-compose.yml file so that docker-compose up -d command knows what to do
scp -i ../../.aws/admin-key-pair-euwest1.pem ./docker-compose.yml ec2-user@ec2-52-212-119-153.eu-west-1.compute.amazonaws.com:~/docker-compose.yml
